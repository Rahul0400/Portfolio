...
// Scroll Reveal animation for project boxes
ScrollReveal().reveal(".project-box", {
  interval: 200, // Animation delay between elements
  origin: "bottom", // Starting position of animation
  distance: "50px", // Distance the element moves
  duration: 1000, // Duration of the animation in ms
  reset: true, // Allows re-animations on scroll
});
...
function showProjectDetails(projectId) {
  ...
  // Show details for the clicked project
...
document.addEventListener("DOMContentLoaded", function () {
  const sendButton = document.getElementById("sendButton"); // Button id
